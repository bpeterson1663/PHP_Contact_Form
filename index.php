...
<html>
  <head>
    <meta charset="utf-8">
    <title></title>
    <script scr="vendors/jquery/dist/jquery.min.js" type="text/javascript"></script>
    ...
    <?php
      if ($_POST['submit']) {
        ...
        if ($error) {
          ...
          if(mail("bpeterson1663@gmail.com","Comment From Website!", "Name: ".$_POST['name']." Email: ".$_POST['email']." Comment: ".$_POST['comment'])){
